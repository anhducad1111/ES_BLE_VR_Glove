...
class IMUConfigUtil:
    ...
    def get_config_from_bytes(data: bytearray, imu_number: int) -> dict:
        ...
        return {
            'accel_gyro_rate': BLEConstants.ACCEL_GYRO_FREQ_MAP[data[positions['accel_gyro_freq']]],
    ...
    @staticmethod
    def update_config_bytes(data: bytearray, imu_number: int, config: dict) -> bytearray:
        ...
        new_config[positions['accel_gyro_freq']] = BLEConstants.ACCEL_GYRO_FREQ_REV_MAP[config['accel_gyro_rate']]
        new_config[positions['mag_freq']] = BLEConstants.MAG_FREQ_REV_MAP[config['mag_rate']]
        new_config[positions['accel_range']] = BLEConstants.ACCEL_RANGE_REV_MAP[config['accel_range']]
        new_config[positions['gyro_range']] = BLEConstants.GYRO_RANGE_REV_MAP[config['gyro_range']]
        new_config[positions['mag_range']] = BLEConstants.MAG_RANGE_REV_MAP[config['mag_range']]
