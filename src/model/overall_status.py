class OverallStatus:
    ...
    def __init__(
        self, fuelgause=NOT_DETECT, imu1=NOT_DETECT, imu2=NOT_DETECT, raw_data=None
    ):
    ...
    def from_bytes(cls, data):
        ...
        try:
            ...
            if (
                fuelgause not in valid_states
                or imu1 not in valid_states
                or imu2 not in valid_states
            ):
                return None
            return cls(fuelgause=fuelgause, imu1=imu1, imu2=imu2, raw_data=data)
